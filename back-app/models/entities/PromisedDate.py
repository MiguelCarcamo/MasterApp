...
class TypePD():
    ...
    _CutNum = None
    _promised_date = None
    _promised_dateAdj = None
    _promised_date2 = None
    _Assigned = None
    
    def __init__(self, Po, Mo, Serial, GruopPO, CutNum, Date1, DateAdj, Date2, Assigned):
        self._Po = Po
        self._Mo = Mo
        self._Serial = Serial
        ...
        self._promised_dateAdj = DateAdj
    ...
    def GetData(self):
        ...
        try:
            ...
            self._promised_date = 'NULL'
        try:
            bx._promised_dateAdj = self._promised_dateAdj
            if bx._promised_dateAdj == '':
                self._promised_dateAdj = 'NULL'
            else:
                self._promised_dateAdj = "'" + self._promised_date + "'"
        except:
            self._promised_date = 'NULL'
        try:
